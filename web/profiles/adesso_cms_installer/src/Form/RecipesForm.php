...
final class RecipesForm extends FormBase {
  ...
  public function getFormId(): string {
    return 'adesso_cms_installer_recipes_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state): array {
    ...
    $base_recipe_path = InstalledVersions::getInstallPath('adesso/adesso_cms_starter');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state): void {
    ...
    $install_state['parameters']['recipes'] = ['adesso_cms_starter'];
