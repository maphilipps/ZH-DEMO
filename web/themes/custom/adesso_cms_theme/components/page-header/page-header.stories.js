...
export default {
  ...
  argTypes: {
    ...
    navbar_transparent: {
      control: 'boolean',
      description:
        'Whether to make the navbar transparent (used with landing variant)',
    },
  },
};
...
export const Default = {
  ...
  args: {
    ...
    description:
      'Find answers to common questions and get the help you need from our comprehensive support resources.',
    background_image:
...
export const Landing = {
  ...
  args: {
    ...
    description:
      'Discover innovative solutions that drive growth and success in the digital age.',
    background_image:
      'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply',
...
export const Hero = {
  ...
  args: {
    ...
    description:
      'Experience next-generation technology solutions that revolutionize how you work and connect.',
    background_image:
      'https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&auto=format&fit=crop&w=2830&h=1500&q=80',
...
export const HeroVideoReady = {
  ...
  args: {
    ...
    description:
      "Built for tomorrow's challenges with today's most advanced technologies.",
    background_image:
      'https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=2830&h=1500&q=80',
...
export const LongContent = {
  ...
  args: {
    ...
    description:
      'We help organizations navigate the complexities of digital transformation with comprehensive solutions that include cloud migration, data analytics, artificial intelligence integration, and custom software development tailored to your specific business needs.',
    background_image:
      'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply',
...
export const LandingLongContent = {
  ...
  args: {
    ...
    description:
      'We create immersive digital experiences that transform how businesses connect with their customers, leveraging cutting-edge technology and innovative design principles to drive engagement and growth.',
    background_image:
      'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-y=.8&w=2830&h=1500&q=80&blend=111827&sat=-100&exp=15&blend-mode=multiply',
