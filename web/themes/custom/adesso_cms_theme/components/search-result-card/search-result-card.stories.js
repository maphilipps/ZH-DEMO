...
const Template = args =>
  renderTwig('search-result-card/search-result-card.twig', args);
...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'Reusable search result card component for Gemeinde Bruchtal municipal portal with WCAG 2.1 AA accessibility compliance and Schema.org structured data.',
      },
    },
  },
  argTypes: {
    ...
    municipal_verified: {
      control: 'boolean',
      description:
        'Whether this content is officially verified by Gemeinde Bruchtal',
    },
  },
};
...
HighRelevanceClub.args = {
  ...
  excerpt:
    'Der <strong>FC Bruchtal</strong> ist einer der traditionsreichsten <strong>Vereine</strong> der Gemeinde. Seit 1954 fördern wir den lokalen Fussballsport.',
  content_type: 'club',
...
MediumRelevanceBusiness.args = {
  ...
  excerpt:
    'Das <strong>Restaurant Seegarten</strong> bietet regionale Küche mit herrlichem Blick auf den Zürichsee. Täglich frische Gerichte aus lokalen Zutaten.',
...
LowRelevanceMunicipal.args = {
  ...
  excerpt:
    'Die <strong>Gemeindeverwaltung Bruchtal</strong> ist Montag bis Freitag von 8:00 bis 17:00 Uhr für Sie da. Termine nach Vereinbarung möglich.',
  content_type: 'page',
  relevance_score: 0.45,
  categories: [{ id: '1', title: 'Verwaltung', url: '/kategorie/verwaltung' }],
  target_groups: [
...
EventResult.args = {
  ...
  excerpt:
    'Das traditionelle <strong>Seefest</strong> findet am 15. August 2024 statt. Ein Tag voller Musik, lokaler Küche und Aktivitäten für die ganze Familie am schönen Zürichsee.',
  content_type: 'event',
