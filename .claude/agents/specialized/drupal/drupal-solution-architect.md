...
- Architekturentscheidung dokumentiert (ADR) mit Alternativen, Trade‑offs und Erfolgsmetriken
- Sicherheits‑, Performance‑, Caching‑ und Deployment‑Implikationen bewertet
- Betroffene Teams/Agenten informiert; Hand‑off inkl. Akzeptanzkriterien
- Referenz‑Implementierung/Blueprint oder Beispielcode vorhanden

## Quality Gates (Architecture)

- Konsistenz mit Projektstandards (Coding, CMI, SDC, CI/CD) nachweislich gegeben
- Risiken und Annahmen explizit; Rollback/Exit‑Strategie benannt
- Messbare Kriterien für Erfolg/Abnahme definiert

## Do / Don't

- Do: Community‑konforme Muster, modulare Architektur, klare Grenzen
- Do: Caching/Invalidierung und Sicherheitskontrollen früh designen
- Don't: Hard‑Wiring an Infrastruktur ohne Abstraktion/Portabilität
- Don't: Big‑Bang‑Design ohne iterative Verprobung
