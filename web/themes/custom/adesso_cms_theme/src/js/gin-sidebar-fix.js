        ...
        if (typeof window.Drupal?.ginSidebar !== 'undefined') {
          ...
          window.Drupal.ginSidebar.collapseSidebar = () => {
            try {
              ...
              if (!sidebarTrigger) {
                console.debug(
                  'Gin sidebar trigger not found, skipping collapse'
                );
                return;
              }
              ...
              if (!spanElement) {
                console.debug(
                  'Gin sidebar trigger span not found, skipping collapse'
                );
                return;
              }
              ...
              console.debug(
                'Gin sidebar collapseSidebar error caught:',
                error.message
              );
            }
          };
          ...
          window.Drupal.ginSidebar.showSidebar = () => {
            try {
              ...
              if (!spanElement) {
                console.debug(
                  'Gin sidebar trigger span not found, skipping show'
                );
                return;
              }
              ...
              console.debug(
                'Gin sidebar showSidebar error caught:',
                error.message
              );
            }
          };
      ...
      window.addEventListener(
        ...
        function (event) {
          ...
          if (
            ...
            console.debug(
              'Gin sidebar querySelector error suppressed:',
              message
            );
        ...
        ResizeObserver.prototype.observe = function (target) {
          try {
            ...
            if (
              ...
              console.debug(
                'ResizeObserver sidebar error caught:',
                error.message
              );
              return;
            }
