...
function initGalleryBehavior(container) {
  ...
  function openLightbox(index) {
    ...
    const imageContainer = lightboxModal.querySelector(
    ...
    if (caption && currentItem) {
      const captionText =
        currentItem.querySelector('.gallery-caption')?.textContent || '';
...
describe('Gallery Component', () => {
  ...
  describe('Basic Rendering', () => {
    it('should render with gallery items', () => {
      const items = [
        renderGalleryItem({
          id: '1',
          media_thumb: '<img src="thumb1.jpg" alt="Item 1">',
          media_description: 'First item',
        }),
        renderGalleryItem({
          id: '2',
          media_thumb: '<img src="thumb2.jpg" alt="Item 2">',
          media_description: 'Second item',
        }),
      ].join('');
  ...
  describe('Gallery Items', () => {
    it('should render gallery item with thumbnail and description', () => {
      const item = {
        id: 'test-1',
        media_thumb:
          '<img src="thumb.jpg" alt="Thumbnail" class="w-full h-full object-cover">',
  ...
  describe('Grid Layout', () => {
    ...
    it('should contain all gallery items in grid', () => {
      const items = [
        renderGalleryItem({
          id: '1',
          media_thumb: '<img src="1.jpg" alt="1">',
        }),
        renderGalleryItem({
          id: '2',
          media_thumb: '<img src="2.jpg" alt="2">',
        }),
        renderGalleryItem({
          id: '3',
          media_thumb: '<img src="3.jpg" alt="3">',
        }),
      ].join('');
    ...
    it('should open lightbox when gallery item is clicked', () => {
      const items = [
        renderGalleryItem({
          id: '1',
          media_thumb: '<img src="1.jpg" alt="1">',
          media_description: 'First image',
        }),
        renderGalleryItem({
          id: '2',
          media_thumb: '<img src="2.jpg" alt="2">',
          media_description: 'Second image',
        }),
      ].join('');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle gallery without headers', () => {
      ...
      expect(
        container.querySelector('.gallery-pre-headline')
      ).not.toBeInTheDocument();
      expect(
        container.querySelector('.gallery-sub-headline')
      ).not.toBeInTheDocument();
    });
    ...
    it('should handle HTML content in descriptions', () => {
      const item = {
        ...
        media_thumb: '<img src="test.jpg" alt="Test">',
        media_description:
          'Description with <strong>HTML</strong> and <a href="#">links</a>',
      };
