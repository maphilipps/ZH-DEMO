...
export const Default = {
  args: {
    ...
    description:
      'Transform your business with our innovative solutions. We provide cutting-edge technology and exceptional service to help you succeed.',
    background_image:
...
export const WithoutImage = {
  args: {
    ...
    description:
      'This version shows the landing page header with a gradient background instead of an image.',
    background_image: '',
    alt_text: '',
    site_name: 'adessoCMS',
    logo: '',
...
export const ShortTitle = {
  args: {
    title: 'Success',
    description:
      'Sometimes less is more. This demonstrates a short, impactful title.',
    background_image:
      'https://images.unsplash.com/photo-1557804506-669a67965ba0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2848&h=1500&q=80',
