...
# to the cache.
DRUPAL_CMS_INSTALLER_WRITE_CACHE=1 drush site:install --yes --sites-subdir=installer-cache --db-url=sqlite://localhost/installer-cache.sqlite adesso_cms_installer 'adesso_cms_installer_recipes_form.add_ons=*'
