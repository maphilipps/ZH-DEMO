...
namespace Drupal\adesso_cms_blocks\Plugin\Block;
...
class PageHeaderBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
      ...
      $plugin_id,
      $plugin_definition,
      $container->get('adesso_cms_blocks.page_header_context'),
  ...
  public function build() {
    ...
    return [
      ...
      '#cache' => [
        ...
        'tags' => $this->getHeaderCacheTags($header_data),
  ...
  protected function hasAdminToolbar() {
    if (!$this->configFactory->get('override_admin_toolbar_margins')) {
  ...
  /**
   * Gets cache tags for the header data.
   *
   * @param array $header_data
   *   Header data from service.
   *
   ...
   *   Cache tags.
   */
  protected function getHeaderCacheTags(array $header_data) {
