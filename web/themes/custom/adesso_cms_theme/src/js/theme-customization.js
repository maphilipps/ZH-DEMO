...
(function (Drupal, once) {
  ...
  function initializeThemeCustomization(form) {
    ...
    const municipalityPresets = form.querySelectorAll('.municipality-preset-selector input[type="radio"]');
  ...
  function updateColorPalette(primaryColor) {
    ...
    let html = '<div class="color-palette-swatches" style="display: flex; flex-wrap: wrap; gap: 8px; margin-top: 10px;">';
  ...
  function updateFontPreview(fontKey) {
    ...
    const fontConfigs = {
      'inter': { family: 'Inter', fallback: 'sans-serif', url: 'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&display=swap' },
      'crimson-text': { family: 'Crimson Text', fallback: 'serif', url: 'https://fonts.googleapis.com/css2?family=Crimson+Text:wght@400;600;700&display=swap' },
      'playfair-display': { family: 'Playfair Display', fallback: 'serif', url: 'https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500;600;700&display=swap' },
      'open-sans': { family: 'Open Sans', fallback: 'sans-serif', url: 'https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;500;600&display=swap' },
      'montserrat': { family: 'Montserrat', fallback: 'sans-serif', url: 'https://fonts.googleapis.com/css2?family=Montserrat:wght@400;500;600&display=swap' }
    };
  ...
  function exportThemeSettings() {
    const colorPicker = document.querySelector('.theme-color-picker');
    const fontSelector = document.querySelector('.theme-font-selector');
    const fontWeights = document.querySelectorAll('input[name*="custom_font_weights"]:checked');
