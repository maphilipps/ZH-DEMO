...
(function (Drupal, once) {
  ...
  Drupal.behaviors.bentoGrid = {
    attach: function (context, settings) {
      const bentoGrids = once('bento-grid-processed', '[data-bento-grid]', context);
  ...
  function addCopyButton(codeBlock) {
    ...
    button.className = 'code-copy-btn absolute top-2 right-2 px-2 py-1 text-xs bg-gray-700 text-white rounded opacity-0 group-hover:opacity-100 transition-opacity';
